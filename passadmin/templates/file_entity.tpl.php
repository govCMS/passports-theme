...
<div id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <?php
    // By default the file entity module includes the file title as a link and
    // hides it with .element-invisible however we don't want that so it is
    // removed here. We also remove the prefix and suffix since we don't want
    // contextual links, since it is not uncommon to end up with links in links
    // when showing these for file entitites.
  ?>
