  ...
  <div class="header__inner clearfix">
    <?php if ($logo): ?>
      <a href="https://dfat.gov.au" class="header__logo" id="dfat-logo" title="Go to the Department of Foreign Affairs and Trade website">
        ...
        <img src="<?php print base_path() . drupal_get_path('theme', 'passports'); ?>/images/dfat-logo.png" alt="Australan Government. Department of Foreign Affairs and Trade logo" class="header__logo-image" />
      </a>
      ...
      <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="header__logo" id="apo-logo"><img src="<?php print $logo; ?>" alt="<?php print t('Go to home page. Australian Passports Office logo'); ?>" class="header__logo-image" /></a>
    <?php endif; ?>
